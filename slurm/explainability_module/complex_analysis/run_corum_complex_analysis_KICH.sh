...
#SBATCH --qos=regular
#SBATCH --job-name=run_corum_complex_analysis_1kidney
#SBATCH --ntasks-per-node=4
#SBATCH --mem=50gb
#SBATCH --nodes=1
#SBATCH --cpus-per-task=4
#SBATCH -o /scratch/jsanchoz/DeepRBP/final_results/explainability/explainer_dl_kout_t_stat/output_final_layer/Kidney_Chromophobe/corum_complex_analysis/logs/run_corum_complex_analysis_1kidney.out
...
python3.9 -m deeprbp.explainability_module.complex_analysis.run_corum_complex_analysis \
    ...
    --scores_file_path "/scratch/jsanchoz/DeepRBP/final_results/explainability/explainer_dl_kout_t_stat/output_final_layer/Kidney_Chromophobe/df_scores_GxRBP.csv" \
    --output_dir "/scratch/jsanchoz/DeepRBP/final_results/explainability/explainer_dl_kout_t_stat/output_final_layer/Kidney_Chromophobe/corum_complex_analysis" \
    --include-non-family
