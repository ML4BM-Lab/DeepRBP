...
#SBATCH --qos=regular
#SBATCH --job-name=real_kds_lines_GSE77702_TAF15_kd    
#SBATCH --cpus-per-task=2
#SBATCH --mem=35GB
#SBATCH --nodes=1
#SBATCH --mail-type=BEGIN,END
#SBATCH --mail-user=jsanchoz@unav.es
#SBATCH -o /scratch/jsanchoz/ML4BM-Lab/DeepRBP/logs/execute_explain_real_kds_lines_GSE77702_TAF15_kd.log
