...
#SBATCH --qos=regular
#SBATCH --job-name=real_kds_lines_GSE77702_TARDBP_kd    
#SBATCH --cpus-per-task=2
#SBATCH --mem=35GB
#SBATCH --nodes=1
#SBATCH --mail-type=BEGIN,END
#SBATCH --mail-user=jsanchoz@unav.es
#SBATCH -o /scratch/jsanchoz/ML4BM-Lab/DeepRBP/logs/execute_explain_real_kds_lines_GSE77702_TARDBP_kd.log
...
python /scratch/jsanchoz/ML4BM-Lab/DeepRBP/main_explain_real_kds.py \
    ...
    --path_data '/scratch/jsanchoz/ML4BM-Lab2/DeepRBP/data/validation_real_kds/GSE77702' \
    --experiment 'GSE77702-kd3' \
    --rbp_interest 'TARDBP' \
